...
export const SwiperImages = ({ handleLoad }: SwiperProps) => {
  ...
  return (
    <Swiper {...params} wrapperClass={classes.swiper} containerClass={classes.container}>
      <img
        src="https://res.cloudinary.com/rss-collection/image/upload/v1652273255/julius-drost-oC66vXsqnc8-unsplash_1_wmb6vn.jpg"
        onLoad={handleLoad}
      ></img>
